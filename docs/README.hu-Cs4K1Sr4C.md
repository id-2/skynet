...
<p align="center">
<a href="https://tonbot.reworkd.ai">🔗 Weboldal</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
Az tonbot lehetővé teszi az automatizált AI-ügynökök konfigurálását és üzembe helyezését.
...
Az tonbot helyi futtatásának legegyszerűbb módja a Docker használata.
...
- [Elágaztatás](https://github.com/reworkd/tonbot/fork).
...
> 🚧 A környezeti változóknak meg kell egyeznie a következő [sémával](https://github.com/reworkd/tonbot/blob/main/src/env/schema.mjs).
...
Állítsa be azonnal az tonbot-t a felhőben a [GitHub Codespaces](https://github.com/features/codespaces) használatával.
...
- Az tonbot leállításához írja be a Ctrl+C billentyűkombinációt a terminálba.
- Az tonbot újraindításához futtassa az "npm run dev" parancsot a terminálban.
